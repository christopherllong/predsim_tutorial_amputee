...
for case in cases:    
    ...
    if 'comVelocityTerm' in settings[case]: #CL added this
        weights['comVelocityTerm'] = (
            settings[case]['comVelocityTerm'])
    ...
    # COM Velocity (MedioLateral) - CL added this
    com_vel_x_idx = F_map['COM_vel_x']
    ...
    if solveProblem: 
        ...
        for j in range(d):
            ...
            ###################################################################
            # CL ADDED: Call external function early to get COM velocity
            Tj = F(ca.vertcat(QsQdskj_nsc[:, j+1], Qddsj_nsc[idxJoints4F, j]))
            COM_vel_x_j = Tj[com_vel_x_idx]  # Extract mediolateral COM velocity
            ...
            comVelocityTerm = COM_vel_x_j**2  # CL ADDED: minimize squared mediolateral COM velocity
            ...
            J += ((weights['metabolicEnergyRateTerm'] * metEnergyRateTerm +
                   ...
                   weights['comVelocityTerm'] * comVelocityTerm +  # CL ADDED
            ...
            # Tj = F(ca.vertcat(QsQdskj_nsc[:, j+1], Qddsj_nsc[idxJoints4F, j])) - CL ADDED
                #Tj already computed above before cost function
    ...
    if analyzeResults:
        ...
        # comVelocityTerm_opt_all = 0 #CL ADDED
        ...
        #         comVelocityTerm_opt = ...#CL ADDED FIX!!!
        ...
        #             h_opt * B[j + 1] / distTraveled_opt)
        #         comVelocityTerm_opt_all += (
        #             weights['controls'] * comVelocityTerm_opt * 
        #             h_opt * B[j + 1] / distTraveled_opt) #CL ADDED
        ...
        #     "comVelocityTerm": comVelocityTerm_opt_all.full()} #CL ADDED
        ...
        #              comVelocityTerm_opt_all.full()) #CL ADDED
